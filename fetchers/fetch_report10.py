...
Usage:
    python fetchers/fetch_report10.py
    python fetchers/fetch_report10.py --from 2024-01-01 --to 2024-12-31
    python fetchers/fetch_report10.py --from 2024-01-01 --to 2024-12-31 --species Cattle Lambs
    python fetchers/fetch_report10.py --output my_data.csv
"""
...
DEFAULT_OUTPUT = REPO_ROOT / "data" / "raw" / "report10_nlrs_slaughter.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default=str(DEFAULT_OUTPUT),
                        help="Output CSV file (default: data/raw/report10_nlrs_slaughter.csv)")
