...
Usage:
    python fetchers/fetch_report8.py
    python fetchers/fetch_report8.py --from 2024-01-01 --to 2024-12-31
    python fetchers/fetch_report8.py --output my_us_prices.csv
"""
...
DEFAULT_OUTPUT = REPO_ROOT / "data" / "raw" / "report8_us_cattle_prices.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default=str(DEFAULT_OUTPUT),
                        help="Output CSV file (default: data/raw/report8_us_cattle_prices.csv)")
