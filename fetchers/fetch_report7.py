...
Usage:
    python fetchers/fetch_report7.py
    python fetchers/fetch_report7.py --from 2024-01-01 --to 2024-12-31
    python fetchers/fetch_report7.py --countries AUS
    python fetchers/fetch_report7.py --countries USA
    python fetchers/fetch_report7.py --output my_global_prices.csv
"""
...
DEFAULT_OUTPUT = REPO_ROOT / "data" / "raw" / "report7_global_cattle_prices.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", default=str(DEFAULT_OUTPUT),
                        help="Output CSV file (default: data/raw/report7_global_cattle_prices.csv)")
